...
//  Copyright © 2017年 Don Chen. All rights reserved.//  https://github.com/slamdon/Swift-Layout-Example/blob/master/DynamicGridLayout/DynamicGridLayout/ViewController/HomeFlowLayout.swift
//
...
class HomeFlowLayout: UICollectionViewFlowLayout {
    ...
    var items = [BikeStationEntity]()
    var layoutType:LayoutType = .threeColumn
...
//            let itemHeight = item.size.height * itemWidth / item.size.width
            let itemHeight = CGFloat(100 + (((item.sno?.toInt() ?? 0) % 4) * 20))
